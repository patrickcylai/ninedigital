...
/*
 * Test Cases for DRM filter API endpoint
 */
describe('DRM Filter', () => {
    /*
     * Test the /POST route on a Valid JSON
     */
    describe('/POST Valid JSON', () => {
      it('it should accept the JSON and return a JSON response', (done) => {
        let validJson =
        {
        "payload": [
            {
    ...
    /*
     * Test completely invalid JSON on /POST route
     */
    describe('/POST Invalid JSON', () => {
      it('it should respond with an error', (done) => {
        let invalidJson = 'payload: []';
            chai.request(server)
            .post('/drmfilter')
            .send(invalidJson)
            .end((err, res) => {
    ...
    /*
     * Test valid JSON but with missing properties on /POST route
     */
    describe('/POST Missing Properties', () => {
      it('it should respond with an error', (done) => {
        let invalidJson = { // Missing 'take' property
            'paylod': [], // Misspelled property
            'skip': 0,
            'totalRecords': 75
        };
            chai.request(server)
